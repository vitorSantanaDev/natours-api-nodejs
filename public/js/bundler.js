...
var showAlert = function showAlert(type, alert) {
  hideAlert();
  var markup =
  /*html*/
  "<div class=\"alert alert--".concat(type, "\">").concat(alert, "</div>");
...
exports.logoutFuncionality = exports.loginFuncionality = void 0;
...
function () {
  ...
  return function loginFuncionality(_x) {
    return _ref2.apply(this, arguments);
  };
}();

exports.loginFuncionality = loginFuncionality;

var logoutFuncionality =
/*#__PURE__*/
function () {
  ...
  return function logoutFuncionality() {
    return _ref3.apply(this, arguments);
  };
}();

exports.logoutFuncionality = logoutFuncionality;
  ...
  _regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            url = type === 'password' ? 'update-password' : 'update-current-user';
            _context.prev = 1;
            _context.next = 4;
...
function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoidml0b3JzYW50YW5hZGV2IiwiYSI6ImNsYTFzazlsZDA1bGkzbnJwbGoxZWVyeGsifQ.OPaofUm0-EFlIiEuv9l_yQ';
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (event) {
    event.preventDefault();
    var username = document.querySelector('.form-user-data #name').value;
    var email = document.querySelector('.form-user-data #email').value;
    var photo = document.querySelector('.form-user-data #photo').files[0];
...
if (userPasswordForm) {
  ...
  function () {
    ...
    _regeneratorRuntime().mark(function _callee(event) {
      var buttonSaveNewPassword, currentPassword, newPassword, newPasswordConfirm;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              event.preventDefault();
              buttonSaveNewPassword = document.querySelector('.btn--save-password');
              buttonSaveNewPassword.textContent = 'Updating...';
              currentPassword = document.querySelector('.form-user-password #password-current').value;
              newPassword = document.querySelector('.form-user-password #password').value;
              newPasswordConfirm = document.querySelector('.form-user-password #password-confirm').value;
              _context.next = 8;
...
if (logoutButton) {
  logoutButton.addEventListener('click', _login.logoutFuncionality);
}
...
//# sourceMappingURL=/js/bundler.js.map